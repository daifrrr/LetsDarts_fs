...
module State =
    ...
    let init () : Model * Cmd<Msg> =
        let testPlayers = Game.getPlayers Game.Default
...
module Views =
    let navBrand =
        Bulma.navbarBrand.div [ Bulma.navbarItem.a [ prop.href "https://safe-stack.github.io/"
                                                     navbarItem.isActive
                                                     prop.children [ Html.img [ prop.src "/favicon.png"
                                                                                prop.alt "Logo" ] ] ] ]

    let sections (fieldValue: int, angle: float) (color: string * string) =
        Svg.g [ svg.id (string $"f{fieldValue}")
                svg.transform.rotate -angle
                svg.children [ Svg.use' [ svg.id (string $"s{fieldValue}")
                                          svg.href "#single"
                                          svg.height 400
                                          svg.width 400
                                          svg.y 0
                               ...
                               Svg.use' [ svg.id (string $"d{fieldValue}")
                                          svg.href "#double"
                                          svg.height 500
                                          svg.width 500
                                          svg.y 0
                                          ...
                                          svg.fill (snd color)
                                          svg.onClick Events.handleClick ]
                               Svg.use' [ svg.id (string $"t{fieldValue}")
                                          svg.href "#triple"
                                          svg.height 500
                                          svg.width 500
                                          svg.y 0
    ...
    let dartBoard (model: Model) (dispatch: Msg -> unit) =
        Bulma.box [ prop.children [ Bulma.container [ prop.className "dartboardContainer"
                                                      prop.children [ Svg.svg [ svg.id "svg"
                                                                                ...
                                                                                svg.children [ Svg.defs [ svg.id "defs"
                                                                                                          svg.children [ Svg.path [ svg.id
                                                                                                                                        "sSLICE"
                                                                                                                                    svg.stroke
                                                                                                                                        "#bbbbbb"
                                                                                                                                    svg.strokeWidth
    ...
    let createForm (model: Model) (dispatch: Msg -> unit) =
        Bulma.container [ prop.children [ Bulma.box [ prop.children [ Bulma.title [ text.hasTextCentered
                                                                                    color.hasTextBlack
                                                                                    prop.text "LetsDarts" ]
                                                                      Bulma.columns [ Bulma.column [ Bulma.label "Mode"
                                                                                                     Bulma.select [ prop
                                                                                                                        .value (
                                                                                                                            string
                                                                                                                                model.Game.Mode
                                                                      ...
                                                                      Bulma.columns [ Bulma.column [ Bulma.label [ Bulma.input.checkbox [ prop
                                                                                                                                              .onCheckedChange (
                                                                                                                                                  SwitchDoubleIn
                                                                                                                                                  >> dispatch
                                                                                                                                              )
                                                                                                                                          prop.isChecked
                                                                                                                                              model.Game.DoubleIn ]
                                                                                                                   Bulma.text.span [ prop.style [ style.marginLeft
                                                                                                                                                      8 ]
                                                                                                                                     prop.text
                                                                                                                                         "Double In" ] ] ]
                                                                                      Bulma.column [ Bulma.label [ Bulma.input.checkbox [ prop
                                                                                                                                              .onCheckedChange (
                                                                                                                                                  SwitchDoubleOut
                                                                                                                                                  >> dispatch
                                                                                                                                              )
                                                                                                                   ...
                                                                                                                   Bulma.text.span [ prop.style [ style.marginLeft
                                                                                                                                     ...
                                                                                                                                     prop.text
                                                                                                                                         "Double Out" ] ] ] ]
                                                                      Bulma.columns [ Bulma.column [ Bulma.label
                                                                                                         "Players" ]
                                                                                      Bulma.column [ Bulma.button.a [ color.isInfo
                                                                                                                      prop.text
                                                                                                                          "+"
                                                                                                                      prop.onClick
                                                                                                                          Events.addPlayer ] ] ]
                                                                      model.Game.Players
                                                                      |> List.mapi (fun i p ->
                                                                          Bulma.input.text [ text.hasTextCentered
                                                                                             prop.placeholder p.Name
                                                                                             prop.custom ("index", i)
                                                                                             prop.onChange (
                                                                                                 Events.handleInput i
                                                                                             ) ])
                                                                      |> Fable.React.Helpers.ofList
                                                                      Bulma.button.a [ color.isInfo
                                                                                       prop.text "Start"
                                                                                       prop.onClick (fun _ ->
                                                                                           dispatch GameSettingsSubmit) ] ] ] ] ]
    ...
    let player (p: Player) (dispatch: Msg -> unit) =
        ...
        Bulma.container [ prop.children [ Bulma.columns [ Bulma.column [ column.is3
                                                                         prop.children [ Bulma.text.span (
                                                                                             sprintf "\u2300"
                                                                                         ) ] ]
                                                          Bulma.column [ column.is6
                                                                         text.hasTextCentered
                                                                         prop.children [ Bulma.text.span p.Name ] ]
                                                          Bulma.column [ column.is3
                                                                         prop.children [ Bulma.text.span
                                                                                             p.Legs.Head.CurrentScore ] ] ]
                                          Bulma.columns [ filledList
                                                          |> List.map (fun s ->
                                                              Bulma.column [ column.is4
                                                                             prop.children [ Bulma.tag [ prop.style [ style
                                                                                                                          .width (
                                                                                                                              length.percent
                                                                                                                                  100
                                                                                                                          )
    ...
    let playGame (model: Model) (dispatch: Msg -> unit) =
        Bulma.container [ prop.children [ Bulma.box [ prop.children [ Bulma.title [ text.hasTextCentered
                                                                                    color.hasTextBlack
                                                                                    prop.text "LetsDarts" ]
                                                                      Bulma.columns [ Bulma.column [ text.hasTextCentered
                                                                                                     prop.text
                                                                                                         $"Mode: %d{model.Game.Mode}" ]
                                                                                      Bulma.column [ text.hasTextCentered
                                                                                                     prop.text
                                                                                                         $"Legs: %d{model.Game.Legs}" ]
                                                                                      Bulma.column [ text.hasTextCentered
                                                                                                     prop.text
                                                                                                         $"D/I: {model.Game.DoubleIn}" ]
                                                                                      Bulma.column [ text.hasTextCentered
                                                                                                     prop.text
                                                                                                         $"D/O: {model.Game.DoubleIn}" ] ]
                                                                      model.Game.Players
    ...
    let view (model: Model) (dispatch: Msg -> unit) =
        Bulma.hero [ hero.isFullHeight
                     color.isPrimary
                     prop.style [ style.backgroundSize "cover"
                                  style.backgroundImageUrl "https://unsplash.it/1200/900?random"
                                  style.backgroundPosition "no-repeat center center fixed" ]
                     prop.children [ Bulma.heroHead [ Bulma.navbar [ Bulma.container [ navBrand ] ] ]
                                     Bulma.heroBody [ Bulma.container [ Bulma.columns [ Bulma.column [ column.is4
                                                                                                       prop.children [ match model.State
                                                                                                                           with
                                                                                                                       | Create ->
                                                                                                                           createForm
                                                                                                                               model
                                                                                                                       ...
                                                                                                                       | Running ->
                                                                                                                           playGame
                                                                                                                               ...
                                                                                                                               dispatch
                                                                                                                       | _ ->
                                                                                                                           Bulma.box [ prop.children [ Html.p [ prop.textf
                                                                                                                                                                    "Finished" ] ] ] ] ]
                                                                                        Bulma.column [ column.is8
                                                                                                       prop.children [ dartBoard
                                                                                                                           model
                                                                                                                           dispatch ] ] ] ] ] ] ]
